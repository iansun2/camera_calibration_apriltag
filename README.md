...
| `--tag-size` | `0.035` | tag edge length (meters) |
...
| `size`/`tag_size`/`tag_spacing`/`start_id` | `7x5`/`0.035`/`0.040`/`0` | board geometry |
...
| `tag_size` | `0.035` | tag edge length (meters) |
| `tag_spacing` | `0.040` | tag centre-to-centre distance (meters) |
